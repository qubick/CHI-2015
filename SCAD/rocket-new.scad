...
translate([30, 40, 3]) rotate([0, 270, 0]) rotate([90, 170, 270]) 
	% cloud(1);

translate([1, 40, 25]) rotate([100, 0, 0]) rotate([90, 90, 90]) 
	scale([.7,1,1])
	cloud(1);

translate([-5, 30, 0]) rotate([0, 0, 90])
	hinge();
...
translate([2, 40, 3]) rotate([90, 0, 90]) 
	box();
*/
translate([7, 40, 40]) rotate([90, 0, 90])
	rocket(1);
